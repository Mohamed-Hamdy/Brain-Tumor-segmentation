...
class Pipeline(object):
    ...
    def __init__(self, list_train ,Normalize=True):
        ...
        #print("Done __init__ Function")

        
    def read_scans(self,Normalize):

        train_im=[]
        print(range(len( self.scans_train)))
        for i in range(len( self.scans_train)):
            print("i = " , i)
            print('iteration [{}]'.format(i))
            print(self.scans_train[i])
            
            flair = glob( self.scans_train[i] + '/*_flair.nii')
            t2 = glob( self.scans_train[i] + '/*_t2.nii')
            gt = glob( self.scans_train[i] + '/*_seg.nii')
            t1 = glob( self.scans_train[i] + '/*_t1.nii')
            t1c = glob( self.scans_train[i] + '/*_t1ce.nii')
            ...
            #crop each volume to have a size of (146,192,152)
            z0=1
            y0=29
            x0=42
            z1=147
            ...
            train_im.append(tmp)
            del tmp    
        #print("Done Read Scans Function")
    ...
    def sample_patches_randomly(self, num_patches, d , h , w ):
        ...
        print("Done sample_patches_randomly Function")
    ...
    def norm_slices(self,slice_not): 
        ...
        #print("Done norm_slices Function ")
    ...
    def _normalize(self,slice):
        ...
        '''
        #print("Done _normalize Function")
...
def concatenate ():
    ...
    print("Done cconcatenate Function")


if __name__ == '__main__':
    
    #Paths for Brats2017 dataset
    path_HGG = glob('E:/GP/Dataset/BRATS2017/Brats17TrainingData/HGG/**')
    path_LGG = glob('E:/GP/Dataset/BRATS2017/Brats17TrainingData/LGG/**')


    path_all=path_HGG+path_LGG

    print(len(path_all))
    print(path_all[len(path_all)-1])
    #shuffle the dataset
    ...
    np.save( "./x_training.npy",Patches )
    np.save( "./y_training.npy",Y_labels)
